  ...
  return (
    <>
      <div className="bg-[#F1FAF7] py-28">
        <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-5 container1 mx-auto">
          <div className="flex flex-col items-start flex-1">
            <h1 className="text-6xl font-bold text-textColor font-DINRoundPro leading-[70px] md:w-3/4">
      ...
      <div className="container1 mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center min-w-full gap-10 px-3 my-20 text-xl">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-4 justify-center mb-10">
